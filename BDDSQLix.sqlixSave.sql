...
CREATE TABLE `village` (
  ...
  KEY `village_fk0` (`num_province`),
  CONSTRAINT `village_fk0` FOREIGN KEY (`num_province`) REFERENCES `province` (`num_province`)
...
-- Dump completed on 2021-02-22 12:44:31
